...
4. **Audience View:** Click here to see the [Audience View](doc8.md). This also shows the URL to give to the audience for participation.
5. **Evaluation:** Click here to see the [Evaluation](doc9.md) of the currently active question block.
